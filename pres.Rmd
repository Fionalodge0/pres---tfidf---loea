...
Text data often follows a lognormal (?) distribution, because the english language repeatly uses the same words, such as 'is', 'the', 'a', etc.  Below is the plot of the proportional distributions of words from both the baseball and cricket text.  
...
Sometimes, it may be appropriate to use frequency counts as a vector representation for text, but often it may not be an accurately describe the features.  This is the 'bag of words' vector representation of text.  
